...
<head>
  ...
  <link rel="apple-touch-icon" href="wbs/assets/img/apple-touch-icon.png">
  <link rel="icon" href="wbs/assets/img/favicon.ico">
  <link rel='stylesheet' href='wbs/Css/bootstrap.min.css'>
  <link rel='stylesheet' href='wbs/Css/vendor.css'>
  <link rel='stylesheet' href='wbs/Css/style.css'>
  <link rel='stylesheet' href='wbs/Css/custom.css'>
  <!--[if lte IE 9]><!-->
  <script src='wbs/Scripts/html5shiv.min.js'></script>
  <!--<![endif]-->
</head>
<body>
  ...
  <div class="site">
      ...
      <header class="site-header">
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a id="login" href="study" >登&nbsp;录</a></li>
        ...
        <!--<nav class="navbar navbar-theme">-->
          <!--<div class="container">-->
            ...
            <!--<div class="collapse navbar-collapse" id="navbar-collapse">-->
              <!--<ul class="nav navbar-nav navbar-right">-->
                <!--&lt;!&ndash;<li class="active"><a href="#home">Home</a></li>&ndash;&gt;-->
                <!--<li><a href="#about" style="color:white;font-size: 17px;">进入学习</a></li>-->
                <!--&lt;!&ndash;<li><a href="#brief_1">Brief</a></li>&ndash;&gt;-->
                <!--&lt;!&ndash;<li><a href="#pricing">Pricing</a></li>&ndash;&gt;-->
                <!--&lt;!&ndash;<li><a href="#download">Download</a></li>&ndash;&gt;-->
                <!--&lt;!&ndash;<li><a href="#contact">Contact</a></li>&ndash;&gt;-->
                <!--&lt;!&ndash;<li class="audio-toggle"><a href="#"><i class="fa fa-volume-up"></i></a></li>&ndash;&gt;-->
              <!--</ul>-->
              ...
              <div class="col-sm-6">
                <div class="col-inner" data-sr="left">
                  <div class="section-heading">
                    <h4>"不一样"的Java学习模式，"微信式"地交互学习,为你筑梦</h4>
                    <h2>以梦为码，不负昭华／用编程对话未来</h2>
                    <div class="checkbox">
                      <label>
                    ...
                    <div class="checkbox ">
                      <label>
                        <input type="checkbox" value="" checked>
                        带给你有趣、好玩、实用、易学、零门槛的编程方法
                      </label>
                    </div>
                    <div class="checkbox ">
                      <label>
                        <input type="checkbox" value="" checked>
                        在游戏中玩转编程，在闯关中闯进世界500强，在挑战中挑战年薪30w+
                      </label>
                    </div>
                  </div> <!-- .section-heading -->
                  <div class="section-content">
                    <!--<a class="btn btn-pink m-y-5" href="#about">Learn More</a>-->
                    <a id="inters" class="btn btn-warning m-y-5" href="study">进入学习>></a>
                  </div> <!-- .section-content -->
                </div>
              </div>
                ...
                <div class="col-inner">
                  ...
                  <div class="section-content">
                    <ul class="icon-list align-l m-t-30">
                      <li><img src="Picture/chat.png" alt=""> Quisque sapien metus, ornare ac suscipit eget.</li>
                      <li><img src="Picture/pencil.png" alt=""> Quisque sapien metus, ornare ac suscipit eget.</li>
            ...
            <div class="row section-content m-t-60-sm-min">
              <div class="col-sm-6 col-md-5">
                <div class="col-inner">
                  ...
                  <div class="icon-box _left">
                    <div class="icon-box-media">
                      <img src="Picture/mail.png" alt="" data-sr="bottom">
                    </div>
                    <div class="icon-box-heading">
                      <h4>Email Address</h4>
                    </div>
	...
	<div id="preferential">
		...
		<div id="preferential2">
			<a id="javaexp" class="btn btn-warning m-y-5" href="#download">java基础语法(体验)</a>
			<del>原价：156元</del>
			<p id="time">新人优惠倒计时：<span>01</span>时<span>04</span>分<span>01</span>秒</p>
			<p id="pricepit">¥</p>
			<p id="pricenum">9.9</p>
			<div id="sign_up">
				<a href="#">立即报名</a>
  ...
  <script src='wbs/Scripts/bootstrap.min.js'></script>
  <script src='wbs/Scripts/plugin.js'></script>
  <script src='wbs/Scripts/variable.js'></script>
  <script src='wbs/Scripts/main.js'></script>
